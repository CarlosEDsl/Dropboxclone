class DropBoxController {
  ...
  connectFirebase(){
    ...
    const firebaseConfig = {
      apiKey: "AIzaSyBgkl9qHwRUaKu5NXJtogIqp84FDX4ruLY",
      authDomain: "dropbox-42eb7.firebaseapp.com",
      databaseURL: "https://dropbox-42eb7-default-rtdb.firebaseio.com",
      projectId: "dropbox-42eb7",
      storageBucket: "dropbox-42eb7.appspot.com",
      messagingSenderId: "795378817427",
      appId: "1:795378817427:web:53e780d16fe763ecfd7066",
      measurementId: "G-TB2SMLB77X"
      };
  ...
  openFolder(){
    ...
    if(this.lastFolder) this.getFirebaseRef(this.lastFolder).off()
    this.renderNav()
    this.readFiles()
        ...
        return `
          <svg version="1.1" id="Camada_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="160px" height="160px" viewBox="0 0 160 160" enable-background="new 0 0 160 160" xml:space="preserve">
              ...
              <g>
                <g>
                    <g filter="url(#mc-content-unknown-large-a)">
                      <pa      this.onselectionchange = new Event('selectionchange')th id="mc-content-unknown-large-b_2_" d="M47,30h66c2.209,0,4,1.791,4,4v92c0,2.209-1.791,4-4,4H47c-2.209,0-4-1.791-4-4V34
                        C43,31.791,44.791,30,47,30z"></path>
                    </g>
                    <g>
                      <path id="mc-content-unknown-large-b_1_" fill="#F7F9FA" d="M47,30h66c2.209,0,4,1.791,4,4v92c0,2.209-1.791,4-4,4H47
